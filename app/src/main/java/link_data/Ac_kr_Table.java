...
public class Ac_kr_Table {
    private String[] ac= {"http://www.kongju.ac.kr","http://www.snu.ac.kr","https://www.snu.ac.kr","https://www.business.kaist.ac.kr",
    ...
    public String[] ac_Kr_Table_Getter(){
        ...
        System.arraycopy(ac,0,new_ac,0,ac.length);//외부에서 직접 접근 방지 객체 복사진행 캡슐화 유지
        return new_ac;
    }
}