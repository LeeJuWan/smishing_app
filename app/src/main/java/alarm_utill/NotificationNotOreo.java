...
public class NotificationNotOreo {
    ...
    public static void send_NotifiCation_Safe(Context context,String str_HEAD,String str_BODY,String str_URL) {
    ...
    // 의심문자 푸시
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public static void send_NotifiCation_NotSafe(Context context,String str_HEAD,String str_BODY,String str_URL) {
    ...
    // 악성코드 푸시
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public static void send_Notification_Malware(Context context,String str_HEAD,String str_BODY,String str_URL) {
    ...
    // 공격자 서버 주소 푸시
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public static void send_Notification_IP(Context context,String str_HEAD,String str_BODY,String str_URL) {
